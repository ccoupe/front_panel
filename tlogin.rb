...
$hscn_sub = "homie/test_bear/screen/control/set"
$hscn_pub = "homie/test_bear/screen/control"
$hcmd_pub = "homie/test_bear/control/cmd/set"
...
# alarm 
$alarm_pub= 'homie/trumpy_test/control/cmd'
...
Shoes.app width: 900, height: 580 do 
  ...
  flow do
    ...
    @panel = stack width: 700 do
      ...
      @img = image "/home/ccoupe/login/images/IF-Garden.JPG", height: 300, width: 400, cache: false,
          align: "center"
      flow do
  ...
  def pict_for(name)
    fps = Dir.glob("/home/ccoupe/.trumpybear/#{name}/face/*.jpg")
    fps.sort!
    return fps[-1]
  end
